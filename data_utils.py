...
class TextMelLoader(torch.utils.data.Dataset):
    ...
    def __init__(self, audiopaths_and_text, hparams, speaker_ids=None):
        ...
        self.candict = candict.Candict().candict
    ...
    def get_mel_text_pair(self, audiopath_and_text):
        ...
        audiopath, text, spk_id = audiopath_and_text[1], audiopath_and_text[0], int(
    ...
    def get_text(self, text):
        text_norm = torch.IntTensor(text_to_sequence(
            text, self.text_cleaners, self.candict))
        return text_norm
...
class TextMelCollate():
    ...
    def __call__(self, batch):
        ...
        spk_ids = torch.LongTensor(
            [batch[ids_sorted_decreasing[i]][2] for i in range(len(ids_sorted_decreasing))])
        for i in range(len(ids_sorted_decreasing)):
        ...
        return text_padded, input_lengths, spk_ids, mel_padded, gate_padded, \
            output_lengths

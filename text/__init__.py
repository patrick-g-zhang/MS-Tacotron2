...
from text.symbols import en_symbols, can_symbols
import pdb
...
def text_to_sequence(text, cleaner_names, dictionary):
    ...
    while len(text):
        ...
        if not m:
            clean_text = _clean_text(text, dictionary, cleaner_names)
        ...
        sequence += _symbols_to_sequence(
            _clean_text(m.group(1), dictionary, cleaner_names))
...
def _clean_text(text, dictionary, cleaner_names):
